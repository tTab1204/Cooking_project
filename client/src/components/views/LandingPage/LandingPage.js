      ...
      <div style={{ padding: "0px" }}>
        ...
        <MiddleBox>
          <VisionTextBox>
            ...
            <VisionParagraph>
              (Cooking)은 요리를 좋아하는, 즐기는 사람들을 위한 요리 공유
              플랫폼입니다. (Cooking)은 자신의 요리를 대접하기를 좋아하던 한
              사람의 아이디어에서 성장했습니다. Cooking은 가정 요리사에서 전문
              요리사에 이르기까지 모든 사람을 지원하고 좋은 음식을 찾는
              사람들에게 최고의 요리사와 공간을 제공합니다.
            </VisionParagraph>
