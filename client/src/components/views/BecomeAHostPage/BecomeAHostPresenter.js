  ...
  return (
    <>
      <Row type='flex'>
        ...
        {ShowSuccess ? (
          <Col lg={24} md={24} xs={24} style={{ display: 'flex', justifyContent: 'center' }}>
            <MiddleBox>
              <Result
                status='success'
          ...
          <Col lg={24} md={24} xs={24} style={{ display: 'flex', justifyContent: 'center' }}>
            <MiddleBox>
              ...
              <Form onSubmit={onSubmit}>
                ...
                {/* Submit Button */}
                <Button onClick={onSubmit} size='large' type='primary' style={{ width: '100%' }}>
                  I'm intersted
                </Button>
              </Form>
            </MiddleBox>
      ...
      <BottomBox>
        ...
        <Paragraph>
          Grow your brand as a chef, test out your new recipes, and share your lovely food with the
          community. You’re in full control of your availability, prices, and rules.
        </Paragraph>
        ...
        <Steps direction='vertical'>
          <Step
            status='finish'
            title='Low fees'
            description='There’s no cost to sign up and host your events. Cooking generally charges lower than the event ticketing industry standard.'
          />
          <Step
            status='finish'
            title='Plan Your Event'
